...
<head>
  ...
  <!-- Favicons -->
  <link rel="icon" href="<?= base_url('assets/') ?>home/img/logoweb.png" type="image/png">
  <link href="<?= base_url() ?><?= base_url() ?>assets/home/img/logoweb.png" rel="apple-touch-icon">
...
<body>
  ...
  <h1 class="logo"><img src="<?= base_url('assets/') ?>home/img/logoweb.png" alt=""><a href="<?= base_url() ?>"><?= $nama_usaha ?></a></h1>
