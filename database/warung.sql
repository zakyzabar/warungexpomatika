...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2024 at 03:27 AM
...
(1, 'Dana', 'Zackyzabar', '085212349852'),
(2, 'Bank BTN', 'Zackyzabar', '8952317234'),
(4, 'OVO', 'Zackyzabar', '082398521045'),
(5, 'GoPay', 'Zackyzabar', '085912394855');
...
(1, 'Zacky Anugrah Akbar', 'zacky@gmail.com', 'Jl. Nyi Arumsari, kec.Talun', 'd8961c122217bcf90a3b968aadf25210', '081279109122', 'Pria', 'pegawai'),
(2, 'Aidil Fazry', 'aidil@gmail.com', 'Jln. Syekh nurjati  gang karsng anyar rt 02 rw 02, desa wanasaba kidul kecamatan talun', 'c6aeb702d8a7c203cdcb4d909bbc8aa6', '085645121991', 'Pria', 'pegawai'),
(3, 'Bos Admin', 'admin@gmail.com', 'Jl. Brigjen Sudarsono', '21232f297a57a5a743894a0e4a801fc3', '0851248238', 'Pria', 'admin'),
(4, 'Muthia Rahmah', 'Mutia@gmail.com', 'arjawinangun cirebon', 'def9cbe59ce34853e7081f62b095e348', '083456789012', 'Perempuan', 'pegawai'),
(5, 'Kanaya Ramadanti', 'Kanaya@gmail.com', 'jalan desa Halimpu kec. Beber', 'Kanaya', '08124325212', 'Perempuan', 'pegawai'),
(6, 'Imelda Fransiska Aulia', 'Imelda@gmail.com', 'Jalan yudhasari II, kelurahan sunyaragi', 'ca6103be5d7f07fadf4486e00e98a32e', '0845678493', 'Perempuan', 'pegawai');
...
(1, 'Warung Expomatika', 'Warung Expomatika sudah dikenal luas oleh pecinta kuliner di Indonesia sebagai restoran halal yang menghadirkan resep internasional yang terinspirasi oleh budaya-budaya yang beragam dari seluruh dunia, dari resep oriental, barat, hingga resep klasik Indonesia yang tak lekang oleh waktu. Tak hanya hidangan khas internasional, minuman dan menu kopi mancanegara pun juga dapat ditemukan di Warung Sehat Ceria bagi pengunjung yang ingin duduk dan bersantai, mengadakan rapat kecil, atau berbaur dengan teman dan keluarga.', 'Jl. Brigjen Darsono, Bypass Jl. Cideng Raya No.20, Kertawinangun, Kec. Kedawung, Kabupaten Cirebon, Jawa Barat 45153', '08123456789', 'warungexpomatika@gmail.com', 'warungexpomatika', 'warungexpomatika', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.4332432397846!2d108.53102017504183!3d-6.716867393278989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6ee3403445aaeb%3A0x9dddaa546ce6e3d8!2sInstitut%20Prima%20Bangsa%20(IPB)%20Cirebon!5e0!3m2!1sid!2sid!4v1720689368380!5m2!1sid!2sid', '11072024111258logo1.jpg', '11072024111258logo2.jpg', '11072024111258logo3.jpg');
...
(4, '2021-10-23', 'Aidil Fazry'),
(7, '2021-11-24', 'Zacky Anugrah Akbar'),
(8, '2021-12-14', 'Muthia Rahmah');
...
(1, 'Aidil Fazry'),
(2, 'Muthia Rahmah'),
(3, 'Imelda Fransiska Aulia'),
(4, 'Kanaya Ramadanti'),
(8, 'Zacky Anugrah Akbar');
